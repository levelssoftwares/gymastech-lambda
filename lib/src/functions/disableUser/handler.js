...
export const toggleUserStatus = async (event) => {
    ...
    const requesterId = (_b = event.queryStringParameters) === null || _b === void 0 ? void 0 : _b.requesterId;
    const requesterRole = (_c = event.queryStringParameters) === null || _c === void 0 ? void 0 : _c.requesterRole;
